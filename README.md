...
1. **Detecção simples**: Baseia-se apenas em rate limiting
2. **Sem persistência**: Dados de bloqueio são perdidos ao reiniciar
3. **Proteção básica**: Não implementa técnicas avançadas como CAPTCHA
4. **Ambiente local**: Projetado para testes educacionais
...
- Ryan Pimentel: ryan.pimentel@ufrr.br
- Leonam Sousa: leonam.sousa@ufrr.br
